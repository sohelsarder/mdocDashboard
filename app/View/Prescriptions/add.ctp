...
/*if($appointment['Appointment']['is_followup'] == 1){	
               ...
               <div class="title_d">
                  <h>Create New Prescription</h>
                     <div class="rmp_info">
                        <div class="menu2">
                           <ul class="tabs">
                                <li>RMP : <?php echo $rmp[0]['User']['name']. $this->Form->hidden('User.rmp',array('label'=>false,'div'=> false,'value'=>$rmp[0]['User']['name'])).$this->Form->hidden('User.rmp_id',array('label'=>false,'div'=> false,'value'=>$rmp[0]['User']['id'])).$this->Form->hidden('User.rp',array('label'=>false,'div'=> false,'value'=>$rmp[0]['User']['phone']));?> </li>
				...
				<div class="control-group">  
                                ...
                                <div class="control-group">
                                    ...
                                    <label class="control-label" for="select01">Would you like to set a follow up appointment?</label>  
                                        <div class="controls">  
                                            <?php echo $this->Form->input('is_followup',array('label'=> false,'options'=> array('0'=>'No','1'=>'Yes'))); ?> 
                                        </div>
